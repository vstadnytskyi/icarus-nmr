...
class Indicators(IndicatorsTemplate):
    ...
    def get(self, value = None):
        ...
        response[b'frequency'] = self.frequency
    ...
    def get_running(self):
        ...
        """
        try:
            reply = getattr(self.device,'running')
        except:
            reply = None #device.controls.running
    ...
    def get_current_values(self):
        ...
        response = {}
        try:
            for key in list(self.device.buffers.keys()):
                response[key] = self.device.buffers[key].get_last_N(1)
        except:
            warning(traceback.format_exc())
            response = None
        return response
    ...
    def get_in_waiting(self):
        ...
        """
        try:
            response = self.device.queue.length
        except:
    ...
    def get_serial_number(self):
        ...
        """
        try:
            return self.device.device_info[b'Serial Number']
        except:
            return None
    ...
    def get_firmware(self):
        ...
        """
        try:
            reply = self.device.device_info[b'Firmware version']
        except:
            reply = None
        return reply
    firmware = property(get_firmware)

    def get_frequency(self):
        from numpy import nan
        try:
            reply = self.device.pr_rate
        except:
            reply = None
        return reply
    ...
    def get_packet_size(self):
        from numpy import nan
        try:
            reply = self.device.pr_packet_size
        except:
            reply = None
        return reply
    packet_size = property(get_packet_size)

    def get_target_pressure(self):
        from numpy import mean
        try:
            reply = mean(self.device.queue.buffer[0,self.device.queue.front-100:self.device.queue.front])
        except:
            reply = None
        return reply
    ...
    def get_sample_pressure(self):
        from numpy import mean
        try:
            reply = mean(self.device.queue.buffer[5,self.device.queue.front-100:self.device.queue.front])
        except:
            reply = None
        return reply
    ...
    def get_pressure_sensor_offset(self):
        try:
            reply = self.device.pressure_sensor_offset
        except:
            reply = None
        return reply
    ...
    def get_last_call_lst(self):
        try:
            reply = self.server.last_call_lst
        except:
            reply = None
        return reply
...
class Controls(ControlsTemplate):
    ...
    def set_DIO(self, value = '00000000'):
        ...
        if device is not None:
            self.device.DIO = value
            sleep((self.devvice.pr_packet_size/4000)*1.1)

    def get_DIO(self):
        from time import sleep
        try:
            reply = int(self.device.queue.buffer[9,icarus_dl.queue.front])
        except:
            reply = None
        return reply
    ...
    def set_DIO_default_pulsed(self,value):
        if isinstance(value,str):
            value = int(value,2)
    if self.device is not None:
        self.device.DIO_default = value
    def get_DIO_default_pulsed(self):
        try:
            reply = self.device.DIO_default
        except:
            reply = None
        return reply
    ...
    def set_pg_pre_pulse_width(self, value = 0.007):
        if self.device is not Nonte:
            self.device.pg_pre_pulse_width = value
    def get_pg_pre_pulse_width(self):
        try:
            reply = icarus_dl.pg_pre_pulse_width
        except:
            reply = None
        return reply
    ...
    def set_pg_depre_pulse_width(self, value = 0.007):
        self.device.pg_depre_pulse_width = value
