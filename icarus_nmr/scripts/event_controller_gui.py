...
class GUI(wx.Frame):
    ...
    def create_GUI(self):
        ...
        self.fields[b'pump_state_high'] = epics.wx.PVButton(self.panel, pv=f"{self.dio_server_name}:bit", pushValue = 1, size = (200,50),label="Pump High", disablePV=f"{self.dio_server_name}:bit0_enable",disableValue=0)
