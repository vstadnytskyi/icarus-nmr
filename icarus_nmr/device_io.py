...
class Indicators(IndicatorsTemplate):
    ...
    def get_current_values(self):
        """
        returns current value from all circular buffers
        ...
        dictionary: dictionary
            dictionary of all current values associated with every circular buffer in the device.buffer dictionary.

        Examples
        --------
        >>> device.get_current_values()
    ...
    def get_s_firmware(self):
        """
        returns dataq's Firmware version
    ...
    def get_s_frequency(self):
        """
        returns data acquisiion frequency in Hz
        ...
        -------
        frequency :: integer
            The frequency as integer in Hz
